...
import PDF from "../img/jd/JD-WEALTH-MANAGER-OPENING.pdf"
  ...
  const formDatas = (e) => {
    ...
    const errorlength = submitData({ Name, Mobile, Email, PostAppliedFor,Cv,isVarified}, { setNameError, setEmailError, setMobileError, setPostAppliedForError,setCvError,setIsVarifiedError})
      ...
      if(errorlength==0){
        ...
        // axios.get("https://nsenmf.com/NMFIIService/NMFService/Bank?BrokerCode=ARN-21399&Appln_Id=MFS21399&password=CO773BGCZIOKYM19").then((res) => {
            ...
            <div className="row">
              <div className="col-md-6">
                <ul className="d-flex">
                  ...
                  <li>
                    <a href="/wealth-manager">
                      <span className="breadcrumb-text"> Wealth Manager </span>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="col-md-6">
              <div className="job-header ">
                ...
                <div className="job-desciption pt-40 pt-sm-20">
                  ...
                  <p>
                    The WM will be required to move into the market and promote
                ...
                <div className="job-desciption pt-50">
                  ...
                  <h4 className="pb-lg-4  pb-sm-4">
                    <b>Package : </b>{" "}
                    <spn className="jd-subtext">Rs. 5 L to 9 L per annum</spn>
                  </h4>
                  <h4 className="pb-lg-4  pb-sm-4">
                    <b>Experience : </b>{" "}
                  ...
                  <h4 className="pb-lg-4  pb-sm-4">
                    <b>Qualification : </b>{" "}
                    <spn className="jd-subtext">MBA in Marketing / Finance</spn>
                  </h4>
                </div>
